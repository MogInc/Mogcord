...
{
    #[must_use]
    /// Creates a new instance of `FileWriter` and ensures the specified folder
    /// path exists.
    ///
    /// # Parameters
    ///
    ...
    ///  
    /// NOTE: This path is ensured to exist by creating the directory and any
    /// necessary parent directories if they do not already exist. # Returns
    ///
    /// - A new instance of `FileWriter`.
    ///
    /// # Panics
    ///
    /// This function will panic if it fails to create the directory or any of
